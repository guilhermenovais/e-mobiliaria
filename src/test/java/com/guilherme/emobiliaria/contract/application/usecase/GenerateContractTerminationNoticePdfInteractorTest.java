...
class GenerateContractTerminationNoticePdfInteractorTest {
  ...
  private GenerateContractTerminationNoticePdfInteractor interactor;
  ...
  void setUp() {
    ...
    interactor =
        new GenerateContractTerminationNoticePdfInteractor(contractRepository, contractFileService);
  ...
  class Execute {
    ...
    @Test
    @DisplayName("When contract exists, should return non-empty termination notice pdf bytes")
    void shouldReturnPdfBytesWhenContractExists() {
      Long id = createContract();

      GenerateContractTerminationNoticePdfOutput output =
          interactor.execute(new GenerateContractTerminationNoticePdfInput(id));
    ...
    void shouldThrowBusinessExceptionWhenContractNotFound() {
      BusinessException ex = assertThrows(BusinessException.class,
          () -> interactor.execute(new GenerateContractTerminationNoticePdfInput(999L)));
