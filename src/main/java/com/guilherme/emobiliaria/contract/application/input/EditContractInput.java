...
public record EditContractInput(Long id, LocalDate startDate, Period duration, int paymentDay,
                                int rent, String purpose, Long paymentAccountId, Long propertyId,
